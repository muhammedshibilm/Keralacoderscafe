...
export function AnimatedBeamDemo() {
  ...
  const div4Ref = useRef<HTMLDivElement>(null) // Center (KccCupMark)
  const div5Ref = useRef<HTMLDivElement>(null)
  const div6Ref = useRef<HTMLDivElement>(null)
  const div7Ref = useRef<HTMLDivElement>(null)
  const div8Ref = useRef<HTMLDivElement>(null) // Left Input - Buy Me a Coffee

  return (
    <div
      className="relative flex h-[500px] w-full items-center justify-center overflow-hidden p-10 bg-zinc-50 rounded-xl border border-zinc-200"
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        
        {/* Left Column (Inputs - 4 Nodes) */}
        <div className="flex flex-col justify-between gap-6 z-10">
          ...
          <Circle ref={div8Ref} className="border-amber-400 bg-amber-50">
            <Icons.coffee />
          </Circle>
        </div>

        {/* Center Column (Target - 1 Node) */}
        <div className="flex flex-col justify-center z-10">
          <Circle ref={div4Ref} className="size-16 p-0 overflow-hidden border-black bg-black">
            <KccCupMark className="w-full h-full" />
          </Circle>
        </div>

        {/* Right Column (Outputs - 3 Nodes) */}
        <div className="flex flex-col justify-between gap-6 z-10">
          <Circle ref={div5Ref}>
            <Icons.googleDocs />
          </Circle>
      ...
      {/* Left Columns connecting to Center (KCC) */}
      <AnimatedBeam
      ...
      {/* Right Columns connecting to Center (KCC) - Reverse Beams */}
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={div5Ref}
        toRef={div4Ref}
...
const Icons = {
  ...
  whatsapp: () => (
    ...
    >
      ...
      />
      <path
        d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.312-6.179 22.558 23.146-6.069 2.235 1.324c9.387 5.571 20.15 8.518 31.126 8.523h.023c33.707 0 61.139-27.426 61.153-61.135.006-16.335-6.349-31.696-17.895-43.251A60.75 60.75 0 0 0 87.94 25.983c-33.733 0-61.166 27.423-61.178 61.13z"
        fill="url(#b)"
      />
      <path
